<div class="layui-body" style="padding: 15px;">
    ...
    <button id="menu_add" class="layui-btn layui-btn-xs">新增模块</button>
        ...
        <?php foreach ($nodes
            ...
            <div class="layui-colla-item">
                <h2 class="layui-colla-title">
                    ...
                    <button class="layui-btn layui-btn-xs layui-btn-normal" style="float: right;margin-top: 10px">新增节点
                    </button>
                </h2>
            ...
            layer.open({
                ...
                , yes: function (index) {
                    ...
                    $.ajax({
                        type: "post",
                        url: _addModule,
                        data: {"cn_name":cnName,"en_name":enName},
